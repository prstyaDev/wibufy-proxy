...
const config = {
  baseurl: getEnv('HIANIME_BASE_URL', 'https://hianime.dk'),
  baseurl_v2: getEnv('HIANIME_BASE_URL_V2', 'https://hianime.dk'),
  ...
  cfClearance: getEnv('CF_CLEARANCE', ''),
  cfUserAgent: getEnv('CF_USER_AGENT', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36'),
};
